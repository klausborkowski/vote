...
// IRubyscoreAchievementMintParams is an auto generated low-level Go binding around an user-defined struct.
type IRubyscoreAchievementMintParams struct {
...
// GetTransferStatus is a free data retrieval call binding the contract method 0xb93c3770.
//
// Solidity: function getTransferStatus(uint256 tokenId) view returns(bool)
func (_Contract *ContractCaller) GetTransferStatus(opts *bind.CallOpts, tokenId *big.Int) (bool, error) {
	var out []interface{}
	err := _Contract.contract.Call(opts, &out, "getTransferStatus", tokenId)
...
//
// Solidity: function getTransferStatus(uint256 tokenId) view returns(bool)
func (_Contract *ContractSession) GetTransferStatus(tokenId *big.Int) (bool, error) {
	return _Contract.Contract.GetTransferStatus(&_Contract.CallOpts, tokenId)
}

// GetTransferStatus is a free data retrieval call binding the contract method 0xb93c3770.
//
// Solidity: function getTransferStatus(uint256 tokenId) view returns(bool)
func (_Contract *ContractCallerSession) GetTransferStatus(tokenId *big.Int) (bool, error) {
	return _Contract.Contract.GetTransferStatus(&_Contract.CallOpts, tokenId)
}

// GetUserNonce is a free data retrieval call binding the contract method 0x6834e3a8.
//
// Solidity: function getUserNonce(address userAddress) view returns(uint256)
func (_Contract *ContractCaller) GetUserNonce(opts *bind.CallOpts, userAddress common.Address) (*big.Int, error) {
	var out []interface{}
	err := _Contract.contract.Call(opts, &out, "getUserNonce", userAddress)
...
//
// Solidity: function getUserNonce(address userAddress) view returns(uint256)
func (_Contract *ContractSession) GetUserNonce(userAddress common.Address) (*big.Int, error) {
	return _Contract.Contract.GetUserNonce(&_Contract.CallOpts, userAddress)
}

// GetUserNonce is a free data retrieval call binding the contract method 0x6834e3a8.
//
// Solidity: function getUserNonce(address userAddress) view returns(uint256)
func (_Contract *ContractCallerSession) GetUserNonce(userAddress common.Address) (*big.Int, error) {
	return _Contract.Contract.GetUserNonce(&_Contract.CallOpts, userAddress)
}
...
// SafeMint is a paid mutator transaction binding the contract method 0x7c2ccc45.
//
// Solidity: function safeMint((address,uint256,uint256[]) mintParams, bytes operatorSignature) payable returns()
func (_Contract *ContractTransactor) SafeMint(opts *bind.TransactOpts, mintParams IRubyscoreAchievementMintParams, operatorSignature []byte) (*types.Transaction, error) {
	return _Contract.contract.Transact(opts, "safeMint", mintParams, operatorSignature)
}

// SafeMint is a paid mutator transaction binding the contract method 0x7c2ccc45.
//
// Solidity: function safeMint((address,uint256,uint256[]) mintParams, bytes operatorSignature) payable returns()
func (_Contract *ContractSession) SafeMint(mintParams IRubyscoreAchievementMintParams, operatorSignature []byte) (*types.Transaction, error) {
	return _Contract.Contract.SafeMint(&_Contract.TransactOpts, mintParams, operatorSignature)
}

// SafeMint is a paid mutator transaction binding the contract method 0x7c2ccc45.
//
// Solidity: function safeMint((address,uint256,uint256[]) mintParams, bytes operatorSignature) payable returns()
func (_Contract *ContractTransactorSession) SafeMint(mintParams IRubyscoreAchievementMintParams, operatorSignature []byte) (*types.Transaction, error) {
	return _Contract.Contract.SafeMint(&_Contract.TransactOpts, mintParams, operatorSignature)
}
...
func (_Contract *ContractTransactor) SetBaseURI(opts *bind.TransactOpts, newBaseURI string) (*types.Transaction, error) {
	return _Contract.contract.Transact(opts, "setBaseURI", newBaseURI)
}

// SetBaseURI is a paid mutator transaction binding the contract method 0x55f804b3.
//
// Solidity: function setBaseURI(string newBaseURI) returns()
func (_Contract *ContractSession) SetBaseURI(newBaseURI string) (*types.Transaction, error) {
	return _Contract.Contract.SetBaseURI(&_Contract.TransactOpts, newBaseURI)
}

// SetBaseURI is a paid mutator transaction binding the contract method 0x55f804b3.
//
// Solidity: function setBaseURI(string newBaseURI) returns()
func (_Contract *ContractTransactorSession) SetBaseURI(newBaseURI string) (*types.Transaction, error) {
	return _Contract.Contract.SetBaseURI(&_Contract.TransactOpts, newBaseURI)
}

// SetBatchTokenURI is a paid mutator transaction binding the contract method 0xba772d8b.
//
// Solidity: function setBatchTokenURI(uint256[] tokenIds, string[] newTokenURIs) returns()
func (_Contract *ContractTransactor) SetBatchTokenURI(opts *bind.TransactOpts, tokenIds []*big.Int, newTokenURIs []string) (*types.Transaction, error) {
	return _Contract.contract.Transact(opts, "setBatchTokenURI", tokenIds, newTokenURIs)
}

// SetBatchTokenURI is a paid mutator transaction binding the contract method 0xba772d8b.
//
// Solidity: function setBatchTokenURI(uint256[] tokenIds, string[] newTokenURIs) returns()
func (_Contract *ContractSession) SetBatchTokenURI(tokenIds []*big.Int, newTokenURIs []string) (*types.Transaction, error) {
	return _Contract.Contract.SetBatchTokenURI(&_Contract.TransactOpts, tokenIds, newTokenURIs)
}

// SetBatchTokenURI is a paid mutator transaction binding the contract method 0xba772d8b.
//
// Solidity: function setBatchTokenURI(uint256[] tokenIds, string[] newTokenURIs) returns()
func (_Contract *ContractTransactorSession) SetBatchTokenURI(tokenIds []*big.Int, newTokenURIs []string) (*types.Transaction, error) {
	return _Contract.Contract.SetBatchTokenURI(&_Contract.TransactOpts, tokenIds, newTokenURIs)
}
...
func (_Contract *ContractTransactor) SetPrice(opts *bind.TransactOpts, newPrice *big.Int) (*types.Transaction, error) {
	return _Contract.contract.Transact(opts, "setPrice", newPrice)
}

// SetPrice is a paid mutator transaction binding the contract method 0x91b7f5ed.
//
// Solidity: function setPrice(uint256 newPrice) returns()
func (_Contract *ContractSession) SetPrice(newPrice *big.Int) (*types.Transaction, error) {
	return _Contract.Contract.SetPrice(&_Contract.TransactOpts, newPrice)
}

// SetPrice is a paid mutator transaction binding the contract method 0x91b7f5ed.
//
// Solidity: function setPrice(uint256 newPrice) returns()
func (_Contract *ContractTransactorSession) SetPrice(newPrice *big.Int) (*types.Transaction, error) {
	return _Contract.Contract.SetPrice(&_Contract.TransactOpts, newPrice)
}

// SetTokenURI is a paid mutator transaction binding the contract method 0x162094c4.
//
// Solidity: function setTokenURI(uint256 tokenId, string newTokenURI) returns()
func (_Contract *ContractTransactor) SetTokenURI(opts *bind.TransactOpts, tokenId *big.Int, newTokenURI string) (*types.Transaction, error) {
	return _Contract.contract.Transact(opts, "setTokenURI", tokenId, newTokenURI)
}

// SetTokenURI is a paid mutator transaction binding the contract method 0x162094c4.
//
// Solidity: function setTokenURI(uint256 tokenId, string newTokenURI) returns()
func (_Contract *ContractSession) SetTokenURI(tokenId *big.Int, newTokenURI string) (*types.Transaction, error) {
	return _Contract.Contract.SetTokenURI(&_Contract.TransactOpts, tokenId, newTokenURI)
}

// SetTokenURI is a paid mutator transaction binding the contract method 0x162094c4.
//
// Solidity: function setTokenURI(uint256 tokenId, string newTokenURI) returns()
func (_Contract *ContractTransactorSession) SetTokenURI(tokenId *big.Int, newTokenURI string) (*types.Transaction, error) {
	return _Contract.Contract.SetTokenURI(&_Contract.TransactOpts, tokenId, newTokenURI)
}

// SetTransferUnlock is a paid mutator transaction binding the contract method 0x9b3e5573.
//
// Solidity: function setTransferUnlock(uint256 tokenId, bool lock) returns()
func (_Contract *ContractTransactor) SetTransferUnlock(opts *bind.TransactOpts, tokenId *big.Int, lock bool) (*types.Transaction, error) {
	return _Contract.contract.Transact(opts, "setTransferUnlock", tokenId, lock)
}

// SetTransferUnlock is a paid mutator transaction binding the contract method 0x9b3e5573.
//
// Solidity: function setTransferUnlock(uint256 tokenId, bool lock) returns()
func (_Contract *ContractSession) SetTransferUnlock(tokenId *big.Int, lock bool) (*types.Transaction, error) {
	return _Contract.Contract.SetTransferUnlock(&_Contract.TransactOpts, tokenId, lock)
}

// SetTransferUnlock is a paid mutator transaction binding the contract method 0x9b3e5573.
//
// Solidity: function setTransferUnlock(uint256 tokenId, bool lock) returns()
func (_Contract *ContractTransactorSession) SetTransferUnlock(tokenId *big.Int, lock bool) (*types.Transaction, error) {
	return _Contract.Contract.SetTransferUnlock(&_Contract.TransactOpts, tokenId, lock)
}
...
// ContractBaseURISetIterator is returned from FilterBaseURISet and is used to iterate over the raw logs and unpacked data for BaseURISet events raised by the Contract contract.
type ContractBaseURISetIterator struct {
	Event *ContractBaseURISet // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *ContractBaseURISetIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(ContractBaseURISet)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *ContractBaseURISetIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *ContractBaseURISetIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// ContractBaseURISet represents a BaseURISet event raised by the Contract contract.
type ContractBaseURISet struct {
	NewBaseURI common.Hash
	Raw        types.Log // Blockchain specific contextual infos
}
...
//
// Solidity: event BaseURISet(string indexed newBaseURI)
func (_Contract *ContractFilterer) FilterBaseURISet(opts *bind.FilterOpts, newBaseURI []string) (*ContractBaseURISetIterator, error) {

	var newBaseURIRule []interface{}
	for _, newBaseURIItem := range newBaseURI {
		newBaseURIRule = append(newBaseURIRule, newBaseURIItem)
	}

	logs, sub, err := _Contract.contract.FilterLogs(opts, "BaseURISet", newBaseURIRule)
	if err != nil {
		return nil, err
	}
	return &ContractBaseURISetIterator{contract: _Contract.contract, event: "BaseURISet", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event BaseURISet(string indexed newBaseURI)
func (_Contract *ContractFilterer) WatchBaseURISet(opts *bind.WatchOpts, sink chan<- *ContractBaseURISet, newBaseURI []string) (event.Subscription, error) {
	...
	logs, sub, err := _Contract.contract.WatchLogs(opts, "BaseURISet", newBaseURIRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(ContractBaseURISet)
				if err := _Contract.contract.UnpackLog(event, "BaseURISet", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event BaseURISet(string indexed newBaseURI)
func (_Contract *ContractFilterer) ParseBaseURISet(log types.Log) (*ContractBaseURISet, error) {
	event := new(ContractBaseURISet)
	if err := _Contract.contract.UnpackLog(event, "BaseURISet", log); err != nil {
		return nil, err
	}
...
// FilterMinted is a free log retrieval operation binding the contract event 0xff0a1dc048ef1a5e9e2845c6bb6cafd8b8531f3cb15368f4a708dec7d7bc789f.
//
// Solidity: event Minted(address indexed userAddress, uint256 indexed userNonce, uint256[] nftIds)
func (_Contract *ContractFilterer) FilterMinted(opts *bind.FilterOpts, userAddress []common.Address, userNonce []*big.Int) (*ContractMintedIterator, error) {
	...
	var userNonceRule []interface{}
	for _, userNonceItem := range userNonce {
		userNonceRule = append(userNonceRule, userNonceItem)
	}

	logs, sub, err := _Contract.contract.FilterLogs(opts, "Minted", userAddressRule, userNonceRule)
	if err != nil {
		return nil, err
	}
...
// WatchMinted is a free log subscription operation binding the contract event 0xff0a1dc048ef1a5e9e2845c6bb6cafd8b8531f3cb15368f4a708dec7d7bc789f.
//
// Solidity: event Minted(address indexed userAddress, uint256 indexed userNonce, uint256[] nftIds)
func (_Contract *ContractFilterer) WatchMinted(opts *bind.WatchOpts, sink chan<- *ContractMinted, userAddress []common.Address, userNonce []*big.Int) (event.Subscription, error) {
	...
	logs, sub, err := _Contract.contract.WatchLogs(opts, "Minted", userAddressRule, userNonceRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
...
// ParseMinted is a log parse operation binding the contract event 0xff0a1dc048ef1a5e9e2845c6bb6cafd8b8531f3cb15368f4a708dec7d7bc789f.
//
// Solidity: event Minted(address indexed userAddress, uint256 indexed userNonce, uint256[] nftIds)
...
//
// Solidity: event PriceUpdated(uint256 newPrice)
func (_Contract *ContractFilterer) FilterPriceUpdated(opts *bind.FilterOpts) (*ContractPriceUpdatedIterator, error) {

	logs, sub, err := _Contract.contract.FilterLogs(opts, "PriceUpdated")
	if err != nil {
		return nil, err
	}
...
//
// Solidity: event PriceUpdated(uint256 newPrice)
func (_Contract *ContractFilterer) WatchPriceUpdated(opts *bind.WatchOpts, sink chan<- *ContractPriceUpdated) (event.Subscription, error) {

	logs, sub, err := _Contract.contract.WatchLogs(opts, "PriceUpdated")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
...
// ContractTokenURISetIterator is returned from FilterTokenURISet and is used to iterate over the raw logs and unpacked data for TokenURISet events raised by the Contract contract.
type ContractTokenURISetIterator struct {
	Event *ContractTokenURISet // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *ContractTokenURISetIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(ContractTokenURISet)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *ContractTokenURISetIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *ContractTokenURISetIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// ContractTokenURISet represents a TokenURISet event raised by the Contract contract.
type ContractTokenURISet struct {
	TokenId     *big.Int
	NewTokenURI common.Hash
	Raw         types.Log // Blockchain specific contextual infos
}

// FilterTokenURISet is a free log retrieval operation binding the contract event 0xda84ca2183491f179a603e877b2cb058e42195041c2b9c53d746427e519a34df.
//
// Solidity: event TokenURISet(uint256 indexed tokenId, string indexed newTokenURI)
func (_Contract *ContractFilterer) FilterTokenURISet(opts *bind.FilterOpts, tokenId []*big.Int, newTokenURI []string) (*ContractTokenURISetIterator, error) {
	...
	logs, sub, err := _Contract.contract.FilterLogs(opts, "TokenURISet", tokenIdRule, newTokenURIRule)
	if err != nil {
		return nil, err
	}
	return &ContractTokenURISetIterator{contract: _Contract.contract, event: "TokenURISet", logs: logs, sub: sub}, nil
}

// WatchTokenURISet is a free log subscription operation binding the contract event 0xda84ca2183491f179a603e877b2cb058e42195041c2b9c53d746427e519a34df.
//
// Solidity: event TokenURISet(uint256 indexed tokenId, string indexed newTokenURI)
func (_Contract *ContractFilterer) WatchTokenURISet(opts *bind.WatchOpts, sink chan<- *ContractTokenURISet, tokenId []*big.Int, newTokenURI []string) (event.Subscription, error) {
	...
	logs, sub, err := _Contract.contract.WatchLogs(opts, "TokenURISet", tokenIdRule, newTokenURIRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(ContractTokenURISet)
				if err := _Contract.contract.UnpackLog(event, "TokenURISet", log); err != nil {
					return err
				}
				event.Raw = log
...
// ParseTokenURISet is a log parse operation binding the contract event 0xda84ca2183491f179a603e877b2cb058e42195041c2b9c53d746427e519a34df.
//
// Solidity: event TokenURISet(uint256 indexed tokenId, string indexed newTokenURI)
func (_Contract *ContractFilterer) ParseTokenURISet(log types.Log) (*ContractTokenURISet, error) {
	event := new(ContractTokenURISet)
	if err := _Contract.contract.UnpackLog(event, "TokenURISet", log); err != nil {
		return nil, err
	}
...
// ContractTokenUnlockSetIterator is returned from FilterTokenUnlockSet and is used to iterate over the raw logs and unpacked data for TokenUnlockSet events raised by the Contract contract.
type ContractTokenUnlockSetIterator struct {
	Event *ContractTokenUnlockSet // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *ContractTokenUnlockSetIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(ContractTokenUnlockSet)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *ContractTokenUnlockSetIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *ContractTokenUnlockSetIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// ContractTokenUnlockSet represents a TokenUnlockSet event raised by the Contract contract.
type ContractTokenUnlockSet struct {
	TokenId *big.Int
	Lock    bool
	Raw     types.Log // Blockchain specific contextual infos
}

// FilterTokenUnlockSet is a free log retrieval operation binding the contract event 0x784afb92b74f2c9ccd3cb1b9697580a90fadab59d6640bbb915d1637bfbbf008.
//
// Solidity: event TokenUnlockSet(uint256 indexed tokenId, bool indexed lock)
func (_Contract *ContractFilterer) FilterTokenUnlockSet(opts *bind.FilterOpts, tokenId []*big.Int, lock []bool) (*ContractTokenUnlockSetIterator, error) {
	...
	logs, sub, err := _Contract.contract.FilterLogs(opts, "TokenUnlockSet", tokenIdRule, lockRule)
	if err != nil {
		return nil, err
	}
	return &ContractTokenUnlockSetIterator{contract: _Contract.contract, event: "TokenUnlockSet", logs: logs, sub: sub}, nil
}

// WatchTokenUnlockSet is a free log subscription operation binding the contract event 0x784afb92b74f2c9ccd3cb1b9697580a90fadab59d6640bbb915d1637bfbbf008.
//
// Solidity: event TokenUnlockSet(uint256 indexed tokenId, bool indexed lock)
func (_Contract *ContractFilterer) WatchTokenUnlockSet(opts *bind.WatchOpts, sink chan<- *ContractTokenUnlockSet, tokenId []*big.Int, lock []bool) (event.Subscription, error) {
	...
	logs, sub, err := _Contract.contract.WatchLogs(opts, "TokenUnlockSet", tokenIdRule, lockRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(ContractTokenUnlockSet)
				if err := _Contract.contract.UnpackLog(event, "TokenUnlockSet", log); err != nil {
					return err
				}
				event.Raw = log
...
// ParseTokenUnlockSet is a log parse operation binding the contract event 0x784afb92b74f2c9ccd3cb1b9697580a90fadab59d6640bbb915d1637bfbbf008.
//
// Solidity: event TokenUnlockSet(uint256 indexed tokenId, bool indexed lock)
func (_Contract *ContractFilterer) ParseTokenUnlockSet(log types.Log) (*ContractTokenUnlockSet, error) {
	event := new(ContractTokenUnlockSet)
	if err := _Contract.contract.UnpackLog(event, "TokenUnlockSet", log); err != nil {
		return nil, err
	}
...
// ContractWithdrawedIterator is returned from FilterWithdrawed and is used to iterate over the raw logs and unpacked data for Withdrawed events raised by the Contract contract.
type ContractWithdrawedIterator struct {
	Event *ContractWithdrawed // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *ContractWithdrawedIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(ContractWithdrawed)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *ContractWithdrawedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *ContractWithdrawedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// ContractWithdrawed represents a Withdrawed event raised by the Contract contract.
type ContractWithdrawed struct {
	Amount *big.Int
	Raw    types.Log // Blockchain specific contextual infos
}

// FilterWithdrawed is a free log retrieval operation binding the contract event 0x11e9d9f7a772129e26cb0560945658c96b41c42ac6712d233e20c894bfcd00fd.
//
// Solidity: event Withdrawed(uint256 amount)
func (_Contract *ContractFilterer) FilterWithdrawed(opts *bind.FilterOpts) (*ContractWithdrawedIterator, error) {

	logs, sub, err := _Contract.contract.FilterLogs(opts, "Withdrawed")
	if err != nil {
		return nil, err
	}
	return &ContractWithdrawedIterator{contract: _Contract.contract, event: "Withdrawed", logs: logs, sub: sub}, nil
}

// WatchWithdrawed is a free log subscription operation binding the contract event 0x11e9d9f7a772129e26cb0560945658c96b41c42ac6712d233e20c894bfcd00fd.
//
// Solidity: event Withdrawed(uint256 amount)
func (_Contract *ContractFilterer) WatchWithdrawed(opts *bind.WatchOpts, sink chan<- *ContractWithdrawed) (event.Subscription, error) {

	logs, sub, err := _Contract.contract.WatchLogs(opts, "Withdrawed")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(ContractWithdrawed)
				if err := _Contract.contract.UnpackLog(event, "Withdrawed", log); err != nil {
					return err
				}
				event.Raw = log
...
// ParseWithdrawed is a log parse operation binding the contract event 0x11e9d9f7a772129e26cb0560945658c96b41c42ac6712d233e20c894bfcd00fd.
//
// Solidity: event Withdrawed(uint256 amount)
func (_Contract *ContractFilterer) ParseWithdrawed(log types.Log) (*ContractWithdrawed, error) {
	event := new(ContractWithdrawed)
	if err := _Contract.contract.UnpackLog(event, "Withdrawed", log); err != nil {
		return nil, err
	}
